...
func ArticleIDGT(v uuid.UUID) predicate.UserFavorite {
	return predicate.UserFavorite(sql.FieldGT(FieldArticleID, v))
}

// ArticleIDGTE applies the GTE predicate on the "article_id" field.
func ArticleIDGTE(v uuid.UUID) predicate.UserFavorite {
	return predicate.UserFavorite(sql.FieldGTE(FieldArticleID, v))
}

// ArticleIDLT applies the LT predicate on the "article_id" field.
func ArticleIDLT(v uuid.UUID) predicate.UserFavorite {
	return predicate.UserFavorite(sql.FieldLT(FieldArticleID, v))
}

// ArticleIDLTE applies the LTE predicate on the "article_id" field.
func ArticleIDLTE(v uuid.UUID) predicate.UserFavorite {
	return predicate.UserFavorite(sql.FieldLTE(FieldArticleID, v))
}
